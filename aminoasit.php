        ...
        <div class="cardMenu d-flex justify-content-around flex-wrap">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text myCardText">WHEY AMINOS</p>
                    <a href="urunler/WHEY AMINOS.php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                <img src="images/AMINO 2200.webp" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
                    <p class="card-text myCardText">AMINO 2200</p>
                    <a href="urunler/AMINO 2200.php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="urunler/ULTRA AMINO PRO.php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                <img src="images/PREMIUM BCAA PROFESSIONAL.webp" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
                    <p class="card-text myCardText">PREMIUM BCAA PROF.</p>
                    <a href="urunler/PREMIUM BCAA PROF..php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
        </div>
    </section>
