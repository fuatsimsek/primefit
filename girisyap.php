...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Kullanıcı kontrolü
    $sql = "SELECT * FROM uyebilgileri WHERE Email=? AND Sifre=?";
...
<head>
    ...
    <link rel="stylesheet" href="css/stylegiris.css">
        ...
        <div class="girisVeKayitOl-container">
            ...
            <form method="POST" action="">
                <div class="form-group row">
                    <label for="emailgiris" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-10">
                        <input type="email" name="email" class="form-control" id="emailgiris" placeholder="ornek@eposta.com" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Şifre</label>
                    <div class="col-sm-10">
                        <input type="password" name="password" class="form-control" id="sifregiris" placeholder="******" required>
                    </div>
                </div>
                <div class="form-group row girisYapBtnDiv">
                    <div class="col-sm-10">
                        <button type="submit" class="btn btn-primary btn-block girisYapBtn">Giriş Yap</button>
                    </div>
                </div>
                <div class="col-sm-7 hesapOlusturDiv">
                    <a href="kayitol.php" class="hesapOlustur btn">Hesap Oluştur</a>
                </div>
            </form>
        </div>
    </section>
