...
<head>
    ...
    <link rel="stylesheet" href="css/stylehakkinda.css">
...
<body>
    ...
    <section class="hakkimizda">
        <div class="hakkimizda-container">
            <h2>Hakkımızda</h2>
            <p>
                PRIME FIT olarak, spora ve sağlıklı yaşama gönül vermiş bireylerin her zaman yanında olmayı hedefliyoruz.
                Besin takviyelerinden spor ekipmanlarına kadar ihtiyaç duyduğunuz tüm ürünleri en kaliteli ve güvenilir
                markalarla sizlere sunuyoruz.
            </p>
            <p>
                Müşteri memnuniyetini her şeyin üzerinde tutan bir anlayışla, geniş ürün yelpazemiz ve uzman ekibimizle,
                fitness ve sağlıklı yaşam yolculuğunuzda size rehberlik ediyoruz.
                İster evde ister spor salonunda antrenman yapıyor olun, performansınızı ve motivasyonunuzu artıracak
                ürünleri bulmanız için buradayız.
            </p>
            <h3>Neden  PRIME FIT ?</h3>
            <ul>
                <li>%100 orijinal ve güvenilir ürünler</li>
                <li>Aynı gün kargo imkanı</li>
                <li>Koşulsuz iade politikası</li>
                <li>7/24 müşteri desteği</li>
            </ul>
            <p>PRIME FIT ile spor hedeflerinize ulaşmak artık çok daha kolay ve keyifli!</p>
        </div>
    </section>
