...
<body>
    ...
    <section class="cardMenuTitleandMenu">
        <div class="cardTitle">
            <h2 class="cardBaslik">KARBONHİDRAT</h2>
        </div>
        <div class="cardMenu d-flex justify-content-around">
            <div class="card" style="width: 18rem;">
                <img src="images/SUPER MEGA MASS 2000.webp" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
                    <p class="card-text myCardText">SUPER MEGA MASS SB.</p>
                    <a href="urunler/SUPER MEGA MASS SB..php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                <img src="images/SUPER MEGA MASS 2000.webp" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
                    <p class="card-text myCardText">SUPER MEGA MASS BA.</p>
                    <a href="urunler/SUPER MEGA MASS BA..php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                <img src="images/GIANT MEGA MASS 4000.webp" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
                    <p class="card-text myCardText">GIANT MEGA MASS 4000</p>
                    <a href="urunler/GIANT MEGA MASS 4000.php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
            <div class="card" style="width: 18rem;">
                <img src="images/CRASH WEIGHT GAIN.webp" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
                    <p class="card-text myCardText">CRASH WEIGHT GAIN</p>
                    <a href="urunler/CRASH WEIGHT GAIN.php" class="btn btn-primary sepetEklelButon"><span class="inceleBtnText">İNCELE</span></a>
                </div>
            </div>
        </div>
    </section>
