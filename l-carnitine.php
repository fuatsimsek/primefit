...
<body>
    ...
    <section class="cardMenuTitleandMenu">
        <div class="cardTitle">
            <h2 class="cardBaslik">L-CARNITINE</h2>
        </div>
        <div class="cardMenu d-flex justify-content-around flex-wrap">
            ...
            <div class="card" style="width: 18rem;">
                <img src="images/L-CARNITINE 1000.jpg" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
            ...
            <div class="card" style="width: 18rem;">
                <img src="images/L-CARNITINE TABLETS.jpg" class="card-img-top cardImg" alt="..." height="65%">
                <div class="card-body">
                    <h5 class="card-title">PRIME FIT</h5>
