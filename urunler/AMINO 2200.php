...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/AMINO 2200.webp" alt="AMINO 2200" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Amino 2200 (325 Tablet)</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">AMİNO ASİT</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 6 tablet ürünü 1 bardak su ile yutunuz veya çiğneyerek alınız.</li>
                <li>Enerji ve Besin Öğeleri 1 Porsiyon (6 Tablet için):</li>
                <ul>
                    <li>Enerji: 231 kj / 54 kcal</li>
                    <li>Protein: 13 g</li>
                    <li>Karbonhidrat: 0,2 g</li>
                    <li>Şekerden Gelen: 0,2 g</li>
                    <li>Yağ: 0,1 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="1"> <!-- Ürün ID -->
