...
<body>
    ...
    <div class="urunInfo">
        ...
        <div class="detayDiv">
            ...
            <ul>
                <li>1 Porsiyon: 30 g ürün ile 300 ml su karıştırılarak elde edilir.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Enerji: 1226 kj / 288 kcal</li>
                    <li>Protein: 0 g</li>
                    <li>Karbonhidrat: 69 g</li>
                    <li>Şekerden Gelen: 61 g</li>
                    <li>Yağ: < 0,01 g</li>
                    <li>Vitamin E: 20 mg</li>
                    <li>Vitamin B6: 2,35 mg</li>
                    <li>Folik Asit: 330 µg</li>
                    <li>Vitamin B12: 2000 4,2 µg</li>
            ...
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="2"> <!-- Ürün ID -->
