...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/GIANT MEGA MASS 4000.webp" alt="GIANT MEGA MASS 4000" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Mega Mass 4000 (7 kg) - çilekli</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">KARBONHİDRAT</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 150 g ürünün 550 ml yarım yağlı (%1.5 yağlı) süt ile karıştırılması ile hazırlanır.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Enerji: 1564 kj / 368 kcal</li>
                    <li>Protein: 19 g</li>
                    <li>Karbonhidrat: 69 g</li>
                    <li>Şekerden Gelen: 50 g</li>
                    <li>Yağ: 1,9 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="4"> <!-- Ürün ID -->
