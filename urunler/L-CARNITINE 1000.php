...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/L-CARNITINE 1000.jpg" alt="L-CARNITINE 1000" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> L-Carnitine 1000 (60 tablet) - limonlu</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">L-CARNITINE</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 1 tablet ürün içerir.</li>
                <li>Enerji ve Besin Öğeleri 1 porsiyon(1 tablet) için:</li>
                <ul>
                    <li>Karbonhidrat: 1470 mg</li>
                    <li>-Şekerden Gelen: 1100 mg</li>
                    <li>-Polyols’dan Gelen: 1356 mg</li>
                    <li>Yağ: 16 mg</li>
                    <li>L - Carnitine: 1000 mg</li>
                </ul>
            </ul>
            <div class="priceSection">
                <span class="price">₺1559.99</span>
                <form method="POST" action="sepet.php" style="display: inline;">
                <input type="hidden" name="urun_id" value="5"> <!-- Ürün ID -->
