...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/L-CARNITINE LIQUID.jpg" alt="L-CARNITINE LIQUID OR." width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> L-Carnitine Liquid (3000 mg/ampul) - portakallı</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">L-CARNITINE</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 25 ml'lik ampülün 200 ml su ile karıştırılmasıyla hazırlanır.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Vitamin B6: 0,28 mg</li>
                    <li>L - Carnitine: 11600 mg</li>
                </ul>
            </ul>
            <div class="priceSection">
                <span class="price">₺1559.99</span>
                <form method="POST" action="sepet.php" style="display: inline;">
                <input type="hidden" name="urun_id" value="7"> <!-- Ürün ID -->
