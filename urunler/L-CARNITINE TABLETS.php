...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/L-CARNITINE TABLETS.jpg" alt="L-CARNITINE TABLETS" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> L-Carnitine Tablets (60 tablet) - ananaslı</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">L-CARNITINE</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 3 tablet ürünü 1 bardak su ile yutunuz veya çiğneyerek alınız.</li>
                <li>Enerji ve Besin Öğeleri 1 porsiyon(3 tablet) için:</li>
                <ul>
                    <li>L - Carnitine: 900 mg</li>
                    <li>Kolin: 82,5 mg</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="8"> <!-- Ürün ID -->
