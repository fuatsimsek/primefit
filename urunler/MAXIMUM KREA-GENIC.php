...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/MAXIMUM KREA-GENIC.webp" alt="MAXIMUM KREA-GENIC" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Maximum Krea-Genic (554 g)</h3>
            <hr>
            ...
            <ul>
                <li>1 Porsiyon: 7,9 g ürün ile 200 ml su ile karıştırılarak elde edilir.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Kalsiyum: 3000 mg</li>
                    <li>Fosfor: 1405 mg</li>
                    <li>Krea-Genic: 46 g</li>
                    <li>-Kreatin Monohidrattan Gelen: 43 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                <span class="price">₺1559.99</span>
                <form method="POST" action="sepet.php" style="display: inline;">
                <input type="hidden" name="urun_id" value="9"> <!-- Ürün ID -->
