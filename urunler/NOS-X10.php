...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/NOS-X10.webp" alt="NOS-X10" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> NOS-X10 (908 g) - portakallı</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">ENERJİ KAYNAKLARI</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 40 g ürün ile 400 ml su karıştırılarak hazırlanmıştır.</li>
                <li>Enerji ve Besin Öğeleri (1 porsiyon için):</li>
                <ul>
                    <li>Vitamin C: 80 mg</li>
                    <li>Niasin: 16 mg</li>
                    <li>L - Glutamin: 3200 mg</li>
                    <li>Taurin: 2000 mg</li>
                    <li>L - Tirozin: 305 mg</li>
                    <li>L - Arjinin: 5000 mg</li>
                </ul>
            </ul>
            <div class="priceSection">
                <span class="price">₺1559.99</span>
                <form method="POST" action="sepet.php" style="display: inline;">
                <input type="hidden" name="urun_id" value="10"> <!-- Ürün ID -->
