...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/PREMIUM BCAA PROFESSIONAL.webp" alt="PREMIUM BCAA PROF." width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span>Premium BCAA Professional (450 g) - Portakallı</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">AMİNO ASİT</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 15 g ürün ile 250 ml su karıştırılarak elde edilir.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    
                    <li>Vitamin B6: 4,66 mg</li>
                    <li>Potasyum: 1998 mg</li>
                    <li>Sodyum: 1252,1 mg</li>
                </ul>
            </ul>
            <div class="priceSection">
                <span class="price">₺1559.99</span>
                <form method="POST" action="sepet.php" style="display: inline;">
                <input type="hidden" name="urun_id" value="11"> <!-- Ürün ID -->
