...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/PREMIUM HYDRO WHEY.webp" alt="PREMIUM HYDRO WHEY" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Premium Hydro Whey (2,3 kg) çikolatalı krema</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">PROTEİN TOZU</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 35 g ürünün 350 ml su ile karıştırılması ile elde edilir.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Enerji: 1443 kj / 340 kcal</li>
                    <li>Protein: 80 g</li>
                    <li>Karbonhidrat: 2,1 g</li>
                    <li>Şekerden Gelen: 1 g</li>
                    <li>Yağ: 1,2 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="12"> <!-- Ürün ID -->
