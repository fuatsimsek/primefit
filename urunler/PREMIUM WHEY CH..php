...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/PREMIUM WHEY.webp" alt="PREMIUM WHEY CH." width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Premium Whey (2,3 kg) - çikolatalı</h3>
            <hr>
            ...
            <ul>
                ...
                <ul>
                    <li>Enerji: 1626 kj / 384 kcal</li>
                    <li>Protein: 77 g</li>
                    <li>Karbonhidrat: 6,3 g</li>
                    <li>Şekerden Gelen: 4,8 g</li>
                    <li>Yağ: 5,2 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="13"> <!-- Ürün ID -->
