...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/PREMIUM WHEY ISOLATE.webp" alt="AMINO 2200" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Premium Whey Isolate (2,3 kg) - Kırmızı meyveli</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">PROTEİN TOZU</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 30 g ürünün 300 ml su ile karıştırılması ile elde edilir.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Enerji: 1554 kj / 366 kcal</li>
                    <li>Protein: 80 g</li>
                    <li>Karbonhidrat: 3,1 g</li>
                    <li>Şekerden Gelen: 1,7 g</li>
                    <li>Yağ: 1,3 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="14"> <!-- Ürün ID -->
