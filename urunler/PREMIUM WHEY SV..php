...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/PREMIUM WHEY.webp" alt="PREMIUM WHEY S&V." width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Premium Whey (2,3 kg) - çilek & vanilyalı</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">PROTEİN TOZU</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 30 g ürünün 250 ml su ile karıştırılması ile elde edilir.</li>
                <li>1 Porsiyon: 30 g ürünün 250 ml yarım yağlı (%1.5 yağlı) süt ile karıştırılması ile hazırlanır.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Enerji: 1678 kj / 396 kcal</li>
                    <li>Protein: 81 g</li>
                    <li>Karbonhidrat: 7,3 g</li>
                    <li>Şekerden Gelen: 6 g</li>
                    <li>Yağ: 4,9 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="15"> <!-- Ürün ID -->
