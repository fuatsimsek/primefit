...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/PURE CREATINE.webp" alt="PURE CREATINE" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Pure Creatine (600 g)</h3>
            <hr>
            ...
            <ul>
                <li>1 Porsiyon: 3,4 g ürün ile 200 ml su karıştırılarak elde edilir.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Kreatin Monohidrat: 100 g</li>
                    <li>Kreatin’den Gelen: 88 g</li>
            ...
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="16"> <!-- Ürün ID -->
