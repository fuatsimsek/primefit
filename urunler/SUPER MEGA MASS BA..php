...
<body>
    ...
    <div class="urunInfo">
        ...
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Mega Mass 2000 (3 kg) - muzlu</h3>
            <hr>
            ...
            <ul>
                ...
                <ul>
                    <li>Enerji: 1607 kj / 379 kcal</li>
                    <li>Protein: 19 g</li>
                    <li>Karbonhidrat: 71 g</li>
                    <li>Şekerden Gelen: 41 g</li>
                    <li>Yağ: 2,1 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="17"> <!-- Ürün ID -->
