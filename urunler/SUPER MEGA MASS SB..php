...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/SUPER MEGA MASS 2000.webp" alt="SUPER MEGA MASS 2000" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Mega Mass 2000 (3 kg) - çilekli</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">KARBONHİDRAT</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 90 g ürünün 300 ml yarım yağlı (%1.5 yağlı) süt ile karıştırılması ile hazırlanır.</li>
                <li>Enerji ve Besin Öğeleri (100 g için):</li>
                <ul>
                    <li>Enerji: 1606 kj / 378 kcal</li>
                    <li>Protein: 19 g</li>
                    <li>Karbonhidrat: 70 g</li>
                    <li>Şekerden Gelen: 42 g</li>
                    <li>Yağ: 2,2 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="18"> <!-- Ürün ID -->
