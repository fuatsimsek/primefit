...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/ULTRA AMINO PRO.webp" alt="ULTRA AMINO PRO" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Ultra Amino Pro (900 g)</h3>
            <hr>
            <p class="kategorisiText">Kategorisi: <span class="kategoriText">AMİNO ASİT</span></p>
            <p>%BRD: Beslenme Referans Değeri Yüzdesi</p>
            <ul>
                <li>1 Porsiyon: 20 g ürünü 250 ml su ile alınız.</li>
            ...
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="19"> <!-- Ürün ID -->
