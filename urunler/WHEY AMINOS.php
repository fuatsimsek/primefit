...
<body>
    ...
    <div class="urunInfo">
        <!-- Fotoğraf Alanı -->
        <div class="imgDiv">
            <img src="../images/WHEY AMINOS.webp" alt="WHEY AMINOS" width="300px">
        </div>
        <!-- Detay Alanı -->
        <div class="detayDiv">
            <h3><span class="myLogoTitle">PRIME FIT</span> Whey Aminos (300 Tablet)</h3>
            <hr>
            ...
            <ul>
                ...
                <li>1 Porsiyon (6 Tablet için):</li>
                <ul>
                    <li>Enerji: 149 kj / 35 kcal</li>
                    <li>Protein: 7,7 g</li>
                    <li>Karbonhidrat: 0,4 g</li>
                    <li>Şekerden Gelen: 0,4 g</li>
                    <li>Yağ: 0,3 g</li>
                </ul>
            </ul>
            <div class="priceSection">
                ...
                <input type="hidden" name="urun_id" value="20"> <!-- Ürün ID -->
